...
class montatela():
      def __init__(self, manutencao1,janela1, opcao,posx,posy,largura, altura,opcao1):
         ...
         if self.opcao==1 and self.opcao1 == 1: 
             ...
             Label(manutencao1, text= 'Contas - Consulta',font=('Arial', 20) ,fg="black",).grid(column=2,row=0,padx= 90, pady=30)
          ...
          # manutenção Alteração
              ...
              Label(manutencao1, text= 'Contas - Alteração',font=('Arial', 20) ,fg="black",).grid(column=2,row=0,padx= 90, pady=30)
           ...
           #manutenção Exclusão
              ...
              Label(manutencao1, text= 'Contas - Exclusão',font=('Arial', 20) ,fg="black",).grid(column=2,row=0,padx= 90, pady=30)
         ...
         if self.opcao1 == 2:
               ...
               self.nome = Entry(manutencao1,width=50)
               self.nome.grid(row=2, column=1,sticky=W)
               Label(manutencao1, text="Pagamento:",font=('Arial', 15)).grid(row=3, column=0,sticky=W)
               self.endereco= Entry(manutencao1,width=50)
               self.endereco.grid(row=3, column=1,sticky=W)
               Label(manutencao1, text="Desconto:",font=('Arial', 15)).grid(row=4, column=0,sticky=W)
               self.telefone= Entry(manutencao1,width=15)
               # self.telefone.grid(row=4, column=1,sticky=W+E+N+S)
               self.telefone.grid(row=4, column=1,sticky=W)
               Label(manutencao1, text="Valor a Pagar:",font=('Arial', 15)).grid(row=5, column=0,sticky=W)
               self.tipo = Entry(manutencao1,width=3)
               self.tipo.grid(row=5, column=1,sticky=W)
               Label(manutencao1, text="Juros:",font=('Arial', 15)).grid(row=6, column=0,sticky=W)
               self.cpf = Entry(manutencao1,width=16)
               self.cpf.grid(row=6, column=1,sticky=W)
               Label(manutencao1, text="Número do documento:",font=('Arial', 15)).grid(row=7, column=0,sticky=W)
               self.cnpj = Entry(manutencao1,width=17)
               self.cnpj.grid(row=7, column=1,sticky=W)
               Label(manutencao1, text="Tipo de Parcela:",font=('Arial', 15)).grid(row=7, column=0,sticky=W)
               self.cnpj = Entry(manutencao1,width=17)
               self.cnpj.grid(row=7, column=1,sticky=W)
               Label(manutencao1, text="Situação:",font=('Arial', 15)).grid(row=7, column=0,sticky=W)
               self.cnpj = Entry(manutencao1,width=17)
               self.cnpj.grid(row=7, column=1,sticky=W)
               Label(manutencao1, text="Compra ou Serviço:",font=('Arial', 15)).grid(row=7, column=0,sticky=W)
               self.cnpj = Entry(manutencao1,width=17)
               self.cnpj.grid(row=7, column=1,sticky=W)
