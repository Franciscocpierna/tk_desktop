...
class montatela():
      def __init__(self, manutencao1,janela1, opcao,posx,posy,largura, altura,opcao1):
         ...
         if self.opcao1 == 2:
               ...
               Label(manutencao1, text="Nome:",font=('Arial', 15)).grid(row=1, column=2,sticky=W)
               self.nome = Entry(manutencao1,width=50)
               self.nome.grid(row=1, column=3,sticky=W)
               Label(manutencao1, text="Data Compra:",font=('Arial', 15)).grid(row=2, column=0,sticky=W)
               self.compra= Entry(manutencao1,width=10)
               self.compra.grid(row=2,column=1)
               Label(manutencao1, text="Data Vencimento:",font=('Arial', 15)).grid(row=3, column=0,sticky=W)
               self.vencimento= Entry(manutencao1,width=10)
               self.vencimento.grid(row=3, column=1,sticky=W)
               Label(manutencao1, text="Descrição:",font=('Arial', 15)).grid(row=4, column=0,sticky=W)
               self.descricao= Entry(manutencao1,width=50)
               self.descricao.grid(row=4, column=1,sticky=W)
               Label(manutencao1, text="Número do documento:",font=('Arial', 15)).grid(row=5, column=0,sticky=W)
               self.documento = Entry(manutencao1,width=20)
               self.documento.grid(row=5, column=1,sticky=W)
               Label(manutencao1, text="Data Pagamento:",font=('Arial', 15)).grid(row=6, column=0,sticky=W)
               self.pagamento= Entry(manutencao1,width=10)
               self.pagamento.grid(row=6, column=1,sticky=W)
               Label(manutencao1, text="Forma de Pagamento:",font=('Arial', 15)).grid(row=6, column=1,sticky=W)
               self.tipo= Entry(manutencao1,width=10)
               self.tipo.grid(row=6, column=2,sticky=W)
               Label(manutencao1, text="Desconto:",font=('Arial', 15)).grid(row=7, column=0,sticky=W)
               self.desconto= Entry(manutencao1,width=14)
               self.desconto.grid(row=7, column=1,sticky=W)
               Label(manutencao1, text="Juros:",font=('Arial', 15)).grid(row=7, column=0,sticky=W)
               self.juros = Entry(manutencao1,width=15)
               self.juros.grid(row=7, column=1,sticky=W)
               Label(manutencao1, text="Valor a Pagar:",font=('Arial', 15)).grid(row=8, column=0,sticky=W)
               self.valpagar = Entry(manutencao1,width=14)
               self.valpagar.grid(row=8, column=1,sticky=W)
               Label(manutencao1, text="Parcelado:",font=('Arial', 15)).grid(row=9, column=0,sticky=W)
               self.tparcela = Entry(manutencao1,width=2)
               self.tparcela.grid(row=9, column=1,sticky=W)
               Label(manutencao1, text="Compra ou Serviço:",font=('Arial', 15)).grid(row=10, column=0,sticky=W)
               self.cs = Entry(manutencao1,width=2)
               self.cs.grid(row=10, column=1,sticky=W)
