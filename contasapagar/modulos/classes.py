...
class montatela():
      def __init__(self, manutencao1,janela1, opcao,posx,posy,largura, altura,opcao1):
         ...
         if self.opcao1 == 2:
               ...
               Label(manutencao1, text="Desconto:",font=('Arial', 15)).grid(row=5, column=0,sticky=W)
               self.desconto= Entry(manutencao1,width=14)
               # self.telefone.grid(row=4, column=1,sticky=W+E+N+S)
               self.desconto.grid(row=5, column=1,sticky=W)
               Label(manutencao1, text="Valor a Pagar:",font=('Arial', 15)).grid(row=6, column=0,sticky=W)
               self.valpagar = Entry(manutencao1,width=14)
               self.valpagar.grid(row=6, column=1,sticky=W)
               ...
               Label(manutencao1, text="Número do documento:",font=('Arial', 15)).grid(row=8, column=0,sticky=W)
               self.documento = Entry(manutencao1,width=20)
               self.documento.grid(row=8, column=1,sticky=W)
               Label(manutencao1, text="Tipo de Parcela:",font=('Arial', 15)).grid(row=9, column=0,sticky=W)
               self.tparcela = Entry(manutencao1,width=2)
               self.tparcela.grid(row=9, column=1,sticky=W)
               Label(manutencao1, text="Situação:",font=('Arial', 15)).grid(row=10, column=0,sticky=W)
               self.situacao = Entry(manutencao1,width=1)
               self.situacao.grid(row=10, column=1,sticky=W)
               Label(manutencao1, text="Compra ou Serviço:",font=('Arial', 15)).grid(row=11, column=0,sticky=W)
               self.cs = Entry(manutencao1,width=2)
               self.cs.grid(row=11, column=1,sticky=W)
