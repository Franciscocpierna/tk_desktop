...
class montatela():
      def __init__(self, manutencao1,janela1, opcao,posx,posy,largura, altura,opcao1):
         ...
         if self.opcao1 == 2:
               ...
               Label(manutencao1,text=" pressione F6  para nome Fornecedor após entrada do codigo").grid(row=1, column=4,sticky=W)
               ...
               self.compra.grid(row=4,column=1)
               ...
               Label(manutencao1, text="Descrição:",font=('Arial', 15)).grid(row=8, column=2,sticky=W)
               self.desctipo = Entry(manutencao1,width=50)
               self.desctipo.grid(row=8, column=3,sticky=W)
               Label(manutencao1,text=" pressione F7  para tipo de pagamento após digitado código do tipo e data pagamento preenchida ").grid(row=8, column=4,sticky=W)
               Label(manutencao1, text="Desconto:",font=('Arial', 15)).grid(row=9, column=0,sticky=W)
               self.desconto= Entry(manutencao1,width=14)
               self.desconto.grid(row=9, column=1,sticky=W)
               Label(manutencao1, text="Juros:",font=('Arial', 15)).grid(row=10, column=0,sticky=W)
               self.juros = Entry(manutencao1,width=15)
               self.juros.grid(row=10, column=1,sticky=W)
               Label(manutencao1, text="Valor a Pagar:",font=('Arial', 15)).grid(row=11, column=0,sticky=W)
